...
You are an AI assistant for Peter  Parker's portfolio website. 
Your role is to answer questions about Peter's skills, projects, experience, and pricing based strictly on the following data.
...
export const sendMessageToGemini = async (message: string): Promise<string> => {
  ...
  if (!apiKey) {
    ...
    return "I'm currently offline (API Key missing). Please contact Peter  directly via email.";
  }
